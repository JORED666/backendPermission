    ...
    suspend fun execute(call: ApplicationCall) {
        try {
            ...
            if (permit.status.name.lowercase() != "approved") {
                call.respond(HttpStatusCode.BadRequest, ErrorResponse("El permiso debe estar aprobado para generar el documento"))
                return
            }
            ...
            if (!permit.permitDocumentUrl.isNullOrBlank()) {
                ...
                call.respond(HttpStatusCode.OK, mapOf(
                    "message" to "Documento ya existe",
                    "url" to permit.permitDocumentUrl
                ))
                return
            }
            ...
            val pdfBytes = PDFGeneratorService.generatePermitPDF(
            ...
            val cloudinaryUrl = CloudinaryService.uploadFile(
                fileBytes = pdfBytes,
            ...
            call.respond(HttpStatusCode.OK, mapOf(
                "message" to "Documento generado exitosamente",
                "url" to cloudinaryUrl
            ))
